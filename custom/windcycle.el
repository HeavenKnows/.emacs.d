...
(global-set-key (kbd "C-M-<up>") 'windmove-up-cycle)
(global-set-key (kbd "C-M-<down>") 'windmove-down-cycle)
(global-set-key (kbd "C-M-<right>") 'windmove-right-cycle)
(global-set-key (kbd "C-M-<left>") 'windmove-left-cycle)

;; Swap window keybindings
(global-set-key (kbd "S-<up>") 'buffer-up-swap)
(global-set-key (kbd "S-<down>") 'buffer-down-swap)
(global-set-key (kbd "S-<right>") 'buffer-right-swap)
(global-set-key (kbd "S-<left>") 'buffer-left-swap)
